...
export const NativeNotificationTest = () => {
  ...
  const testNotifications = [{
    ...
    actions: [{
      action: 'view',
      title: '👀 Ver ​А​g​е​n​d​а​m​е​n​t​о​ѕ'
    }, {
      action: 'schedule',
      title: '📅 ​А​g​е​n​d​а​r'
    }, {
    ...
    title: '📅 Lembrete de ​А​g​е​n​d​а​m​е​n​t​о',
    body: 'Seu ​а​g​е​n​d​а​m​е​n​t​о é amanhã às 14:00. Não se esqueça!',
    actions: [{
      action: 'view',
      title: '✅ Confirmar'
    }, {
    ...
    title: '🎉 ​А​g​е​n​d​а​m​е​n​t​о Confirmado',
    body: 'Parabéns! Seu ​а​g​е​n​d​а​m​е​n​t​о foi confirmado com sucesso.',
    actions: [{
      action: 'view',
      title: '📋 Ver Detalhes'
    }, {
    ...
    body: 'Complete seu cadastro para finalizar o ​а​g​е​n​d​а​m​е​n​t​о.',
    actions: [{
      action: 'view',
      title: '🔧 Completar'
    }, {
